<section id="screen-0" class="screen-0">
    ...
    <div class="screen-0_text" id="header_text">
        ...
        <div class="screen-0_text_animated selected-profit __animated<?= $profit >= 100 ? ' digit3' : '' ?>"></div>
    </div>
</section>
<div class="wrap-container">
        ...
        <div class="block_currency">
            <?php foreach ($groups as $name => $item): ?>
                <a class="block_currency_item" href="<?= $item['url'] ?>" target="_blank">
                    ...
                    <div class="block_currency_item_pair">BTC / USD</div>
                    <div class="block_currency_item_cost"><?php echo number_format($item['rate'], 1) ?></div>
        ...
        <div class="block_currency min-input">
            <form action="/calculate" method="POST" id="input_self_result">
                <div class="block_input">
                    <div class="block_input_title inform-question" data-hint="Cost of your miner, USD">Miner cost</div>
                    <div class="block_input_box hosting-fee">
                        <input type="text" value="1200" type-number name="Server[price]">
                    </div>
                </div>
                <div class="block_input">
                    <div class="block_input_title inform-question" data-hint="Performance of your miner, GH/s">Hash
                        Rate
                    </div>
                ...
                <div class="block_input">
                    <div class="block_input_title inform-question" data-hint="Power consumption of your miner, W">Power
                        consumption
                    </div>
    ...
    <section class="block">
        <span class="title with_logo"><span class="title_num">3. </span>You can mine Bitcoin with <a
                    href="https://cryptonomos.com/wtt/?r=1HC9GrfEsCBaNEVcVqaF6H4OD"></a></span>
